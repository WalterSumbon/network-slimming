...
if __name__ == '__main__':  #
    ...
    parser.add_argument('--epochs', type=int, default=3, metavar='N',       #default:160
    ...
    parser.add_argument('--from-scratch', '-fs', dest='fs', action='store_true', 
                        help='train pruned model from scratch')
